 ...
 */
export interface DCAHookConfig<TArgs, TResult, TContext = any, TSkillInput = any> {
  before?: BeforeHook<TArgs, TContext, TSkillInput>;
  after?: AfterHook<TResult, TArgs, TContext, TSkillInput>;
}

/**
 * Wraps a VibkitToolDefinition with before/after hooks for the DCA agent.
...
export function withHooks<TParams extends z.ZodTypeAny, TResult, TContext = any, TSkillInput = any>(
  ...
  hooks: DCAHookConfig<z.infer<TParams>, TResult, TContext, TSkillInput>
